...
const exactMap = {
  ...
  "mukimo + beef": "mukimo",
  "mukimo + stew": "mukimo",
  "chicken loaded": "fried chicken",
  "beef loaded": "fried chicken",
  "pork loaded": "fried chicken",
  "masala": "rice & beef",
...
const customImages = {
  ...
  "beef loaded": "https://images.unsplash.com/photo-1544025162-d76694265947?w=500&q=80",
};
...
const customDescriptions = {
  ...
  "ugali plain": "Firm white ugali, the classic Kenyan staple.",
  ...
  "beef stew": "Hearty beef stew cooked with onions and spices.",
  ...
  "chicken loaded": "Loaded chicken platter with all the fixings.",
  "beef loaded": "Loaded beef platter with all the fixings.",
  "pork loaded": "Loaded pork platter with all the fixings.",
  "masala": "Aromatic masala dish served with rice or chapati.",
};
